...
class Country(object):
    ...
    def __init__(self, name=None, pid=None, qty_sold=None, qty_purchased=None, transit_points=None, purchase_plan=None, transit_from=None, transit_to=None, supply_importance=None, usd_per_ton=None):
    ...
    def select_suppliers(self, graph, firm_list, country_list, choose_among_x_pc):
        ...
        for sector in list(set(self.qty_purchased.keys()) & set(dic_sector_to_firmid.keys())): #only select suppliers from sectors that are present
            ...
            #print(sector, choose_among_x_pc[sector], len(dic_sector_to_firmid[sector]))
            nb_selected_suppliers = math.ceil(len(dic_sector_to_firmid[sector])*choose_among_x_pc[sector])
